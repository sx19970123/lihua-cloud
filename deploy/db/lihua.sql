...
INSERT INTO `sys_menu` (`id`, `parent_id`, `label`, `title`, `menu_type`, `router_path`, `component_path`, `visible`, `status`, `perms`, `icon`, `sort`, `create_id`, `create_time`, `update_id`, `update_time`, `del_flag`, `remark`, `cache`, `link_path`, `query`, `view_tab`, `link_open_type`) VALUES (1907043468160172033, '0', 'API文档', 'API文档', 'link', '/doc', NULL, '0', '0', 'link', 'FileTextOutlined', 6, 1, '2025-04-01 20:12:49', '1', '2025-04-05 10:36:37', '0', NULL, '0', 'http://localhost:8080/system/swagger-ui.html', NULL, '0', 'new-page');
